...
        
        # مولد الصفقات التلقائي الثنائي (شراء LONG وبيع SHORT)
...
    <div class="grid">
        <div class="box">
            <div>مؤشر القوة النسبية RSI (إغلاق مؤكد)</div>
...
            <div style="font-size: 15px; font-weight: bold; color: #4CAF50; margin-top: 6px;">~${{ market_cap }} B</div>
        </div>
        <div class="box">
...
            <div style="font-size: 11px; color: #f44336;">مقاومة: ${{
